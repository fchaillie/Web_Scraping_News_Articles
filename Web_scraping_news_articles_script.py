...
def main():
    ...
    # Setting up the arguments that need to be entered in your terminal for the command to work: start date, end date and folder name
                ...
                if date_div:
                    ...
                    if len(dates) > 1:
                        ...
                        if date_update == date_pusblished:
                            date2s.append(' ')  # Append an empty space if update date is the same
                        else:
                            date2s.append(date_update)
                    else:
                        # Append an empty space if there is no update date
                        date2s.append(' ')
                    titles.append(title)
    ...
    if df.shape[0] == 0:
        ...
        # Name of the excel file created in the folder including start_date and end_date
