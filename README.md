...
3. **In your terminal run this command with Docker Desktop application open (don't forget the dot at the end !):**

        docker build -t okx_news_img .

5. **Finally run this command to get the news articles in an excel file in a folder you name here for the time period you choose. The .py file needs to be followed by the start date, the end date and the name of the folder:**
